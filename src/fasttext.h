...
class FastText {
  ...
  public:
    ...
    void saveVectors();
    void getSubVector(Vector&,Vector&, Vector&, Vector&, std::map<int32_t,std::string>&, const int32_t&, std::ofstream&, std::ofstream&, std::ofstream&, std::ofstream&);
    void saveModel();
